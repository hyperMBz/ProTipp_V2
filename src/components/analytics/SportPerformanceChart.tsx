...
import { PieChart, Pie, Cell, BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, Legend, PieLabelProps } from 'recharts';
              ...
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie
                    ...
                    outerRadius={80}
                    dataKey="profit"
                    label={(props: PieLabelProps & { sport: string }) => `${props.sport}: ${(props.percent ? props.percent * 100 : 0).toFixed(0)}%`}
                    labelLine={false}
                  >
