    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-background/50 p-4">
          <Card className="w-full max-w-md border-destructive/20 bg-gradient-to-br from-background to-background/50 backdrop-blur-sm">
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Valami hiba történt az alkalmazás betöltése során
              </CardDescription>
            </CardHeader>
...
export function useErrorHandler() {
  return (error: Error, errorInfo?: React.ErrorInfo) => {
    ...
    // Itt további error reporting logika lehet
  };
}
